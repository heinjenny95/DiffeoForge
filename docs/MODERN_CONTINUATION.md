...
compatibility table names the parent revision; Engine 1.8 currently permits
Engine 1.5 and 1.6 for their unchanged Current/Varifold objective contracts.
Engine 1.7 is deliberately excluded from this version-level allow-list because
it could contain the subsequently removed experimental attachment type. The
