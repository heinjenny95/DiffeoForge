...
The separately tested blockwise full-objective path is not yet selected by
workflow configuration and is therefore intentionally absent from workload v0.1.
