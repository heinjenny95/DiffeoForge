...
The current usability package is implemented and packaged for same-owner local
testing. This is not an installed update, signed release or scientific qualification.
...
| Setup | 322,786,786 bytes; not executed |
...
- Installation and application restart need the user's separate go-ahead. Existing
  scientific studies, installed executables, datasets and QC decisions were not changed.
